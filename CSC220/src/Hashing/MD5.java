...
class MD5
{
    ...
    public static String processTextFile(String filename) throws FileNotFoundException
    {
        try {
    ...
    {
        System.out.println(toHexString(computeMD5(";adfjaoweinfaldnfa]we'pf;'aefka'wel".getBytes())));
        System.out.println(toHexString(computeMD5(":adfjaoweinfaldnfa]we'pf;'aefka'wel".getBytes())));
